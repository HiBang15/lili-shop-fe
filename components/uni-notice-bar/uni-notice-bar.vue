...
/**
 * NoticeBar custom navigation bar
 * @description notice bar component
 * @tutorial https://ext.dcloud.net.cn/plugin?id=30
 * @property {Number} speed The speed of text scrolling, default 100px/sec
 * @property {String} text display text
 * @property {String} backgroundColor background color
 * @property {String} color text color
 * @property {String} moreColor View more text colors
 * @property {String} moreText set the "see more" text
 * @property {Boolean} single = [true|false] Is it single line
 * @property {Boolean} scrollable = [true|false] Whether to scroll, when it is true, the NoticeBar is a single line
 * @property {Boolean} showIcon = [true|false] Whether to show the speaker icon on the left
 * @property {Boolean} showClose = [true|false] Whether to show the left close button
 * @property {Boolean} showGetMore = [true|false] Whether to display the view more icon on the right, when it is true, the NoticeBar is a single line
 * @event {Function} click on NoticeBar to trigger the event
 * @event {Function} close Close NoticeBar trigger event
 * @event {Function} getmore The event is triggered when you click "View More"
 */
...
// Is it single line
    ...
    scrollable: {
// Whether to scroll, control the single-line effect to cancel after adding
      type: [Boolean, String],
      default: false
    },
    showIcon: {
// Whether to display the left icon
    ...
    showGetMore: {
// Whether to display the right side to see more
      type: [Boolean, String],
      default: false
    },
    showClose: {
// Whether to display the left close button
      type: [Boolean, String],
      default: false
    }
  },
