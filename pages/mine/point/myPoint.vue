  ...
  <view class="content">
    <view class="portrait-box">
      ...
      <view class="position-point">
        <view class="apply-point" @click="goIntro"><text>Point introduction</text></view>

      </view>
    </view>
    <u-row class="portrait-box2">
      <u-col span="6" class="portrait-box2-col" :gutter="16">
        <text>Accumulated gains:</text>
...
export default {
  data() {
    return {
      ...
      pointList: [], //Points data collection
      params: {
        pageNumber: 1,
        pageSize: 10,
      },
      pointData: {}, //Accumulated acquisition not entered collection
    };
  },
  ...
  methods: {
    ...
    /**
     * Get accumulated points for use
     */
    initPointData() {
