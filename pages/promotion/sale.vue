<template>
  <view class="sale">
    ...
    <view class="prohibition" :style="'overscroll-behavior: unset;height:' + header.height +'px;'">
      <view class="header">
        ...
        <view @click="goCart" class="right">
          <text class="alifont icon-gouwuche1"
    ...
    <view class="sale-title">
      <view>Today's special offer</view>
    </view>
        ...
        <view class="sale-item-content">
          ...
          <view class="sale-item-price">
            <text class="sale-item-price-now">¥{{ item.price | unitPrice }}
              <!-- <text v-if="item.point">+{{ item.point || 0 }}Points</text> -->
            </text>
          </view>
        </view>
      </view>
...
//Jump to shopping cart
    ...
    goMainPage() {
//Unexplained, unable to go back, try to add parameters to solve the cache problem
      uni.switchTab({
